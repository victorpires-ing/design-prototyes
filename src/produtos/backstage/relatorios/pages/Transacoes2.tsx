...
import { DEFAULT_SELECTED, ManageColumnsModal } from "../components/ManageColumnsModal2";
...
import { EXPORT_FIELD_GROUPS, type ExportFieldGroup } from "../data/export-fields2";
...
const AutocompleteInline = ({
    ...
    return (
        <div className="relative">
            ...
            />
            {aberto && (
                <div className="absolute inset-x-0 top-full z-20 mt-1 flex max-h-56 flex-col gap-0.5 overflow-y-auto rounded-lg bg-primary p-1 shadow-lg ring-1 ring-border-secondary">
                    {filtrados.map((opt, i) => (
                        <button
                            key={opt.id}
                            type="button"
                        ...
                        <div className="flex flex-col gap-3 rounded-lg bg-secondary p-3">
                            ...
                            <div ref={sessaoFieldRef} className="flex flex-col gap-1">
                                <AutocompleteInline
                                    ...
                                    items={DATA_PROVA_OPTIONS.map((d) => ({ id: d, label: d }))}
...
const AguardandoPagamentoCard = ({
    ...
    return (
        <div className="flex flex-col gap-4 rounded-lg bg-secondary p-3 ring-1 ring-border-secondary">
                ...
                <div className="flex items-center justify-between gap-2 border-t border-secondary px-6 py-4">
                    ...
                    >
                        {modoValeTroca ? (
                            ...
                            <Button size="sm" color="secondary" onClick={iniciarEdicaoTodosItens}>
                                Editar
                            </Button>
                        ) : null}
                    </span>
...
const ListaTransacoesCard = ({ rows }: { rows: Transacao[] }) => {
    ...
    // IDs de pedido com edição de itens pendente de pagamento — sobrevive ao fechar o
    // slideout (diferente do estado de pagamento em si, que é local a ele), pra continuar
    // mostrando "Em edição" na tabela mesmo depois de fechar.
