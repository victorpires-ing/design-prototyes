...
/* ------------------------------------------------------------------ */
/*  Brand palette (Grêmio landing — intrinsic brand colors)           */
/* ------------------------------------------------------------------ */
...
const Hero = () => (
    <section
        ...
        style={{ backgroundImage: `url(${GremioHero})` }}
    >
        <div
            aria-hidden="true"
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center">
            ...
            <h1 className="mt-6 max-w-lg text-center text-[40px] font-medium leading-tight tracking-tight text-white md:text-6xl">
                Ingressos para os eventos do Grêmio
            </h1>
        </div>
...
const EventCard = ({ evento }: { evento: EventoCard }) => (
    <article className="flex h-full flex-col rounded-2xl bg-white p-3">
        ...
        <div className="mt-3 flex flex-1 flex-col gap-1 pt-0">
            ...
            <span className="mt-auto text-sm font-bold" style={{ color: BLUE }}>
                {evento.date}
            </span>
        </div>
    </article>
...
const Poster = ({ evento }: { evento: EventoCard }) => (
    <img
        src={evento.poster}
        alt={evento.title}
        loading="lazy"
        ...
        <div className="relative z-10 mx-auto flex min-h-[520px] w-full max-w-[1280px] flex-col px-4 py-8 md:min-h-[640px] md:px-6 md:py-12">
            ...
            <div className="mt-auto flex max-w-xl flex-col items-start gap-5">
                <span
                    ...
                    style={{
                        backgroundColor: "rgba(28,164,227,0.25)",
                        boxShadow: "inset 0 0 0 1px rgba(28,164,227,0.6)",
                    }}
                >
                    Temporada 2026 · Arena do Grêmio
                </span>
                <h1 className="text-4xl font-extrabold leading-[1.05] tracking-tight text-white md:text-6xl">
                    Viva cada jogo de pertinho
                </h1>
                <p className="max-w-md text-base text-white/80 md:text-lg">
                    Ingressos oficiais para os eventos do Tricolor. Garanta seu lugar e sinta a
                    emoção da torcida ao vivo, do primeiro ao último minuto.
                </p>
            </div>
        </div>
    </section>
...
const Experiences = ({ eventos }: { eventos: EventoCard[] }) => (
...
const DependentsNotice = () => (
    <section
        ...
        style={{
            backgroundColor: "rgba(28,164,227,0.10)",
            boxShadow: "inset 0 0 0 1px rgba(28,164,227,0.35)",
        }}
    >
        <div className="flex items-start gap-4">
            <FeaturedIcon
                ...
                color="brand"
                theme="gradient"
                className="before:border-[#1CA4E3]/30 before:bg-[#1CA4E3]/10 after:bg-[#1CA4E3]"
            />
        ...
        <div className="flex flex-col gap-10 md:flex-row md:justify-between">
            ...
            <div className="flex flex-col gap-10 sm:flex-row sm:gap-16">
                <nav className="flex flex-col gap-3">
                    ...
                    <FooterLink>Site Grêmio Oficial</FooterLink>
                    <FooterLink>Loja Grêmio</FooterLink>
                    <FooterLink>Fale com o Grêmio</FooterLink>
                </nav>

                <div className="flex max-w-xs flex-col gap-3">
                    <span className="text-sm font-bold">Siga o Grêmio</span>
                    <p className="text-sm text-white/85">
                        As novidades do clube e opinião da torcida estão nas redes sociais.
                    </p>
