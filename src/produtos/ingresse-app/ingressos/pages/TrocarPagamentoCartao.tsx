...
/** Pagamento por cartão da diferença da troca — cenário rápido: confirma e vai direto ao sucesso. */
export function TrocarPagamentoCartao() {
    ...
    const finalizar = () => {
        navigate(`/ingresse-app/ingressos/trocar/${evento.id}/${itemId}/sucesso`);
    };
                        ...
                        <div className="mt-2 flex flex-col">
                            {parcelas.map((p) => (
                                <button
                                    ...
                                    className={cx("-mx-2 flex items-center gap-3 rounded-xl px-2 py-3 text-left transition duration-100 ease-linear", parcela === p.id && "bg-secondary")}
                                >
