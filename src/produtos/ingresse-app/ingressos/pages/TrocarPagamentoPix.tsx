...
/** Pagamento via Pix da diferença da troca. Ao copiar o código, segue para a tela de sucesso. */
export function TrocarPagamentoPix() {
                ...
                <div className="flex flex-col gap-4 px-5 pt-2 pb-8">
                    ...
                    <section className="rounded-2xl bg-primary p-5 ring-1 ring-border-secondary">
                        ...
                        <p className="mt-3 text-sm leading-relaxed text-tertiary">
                            Assim que o pagamento for concluído, a troca será realizada. Copie o código abaixo e cole no app do seu banco para pagar com Pix
                            Copia e Cola.
                        </p>
                        ...
                        <div className="mt-4 border-t border-secondary pt-3">
                            ...
                            {comoOpen && (
                                <p className="mt-2 text-sm leading-relaxed text-tertiary">
                                    O valor pago é a diferença entre o ingresso atual e o novo. Após a confirmação do Pix, a troca é realizada automaticamente e o
                                    novo ingresso fica disponível na sua carteira.
                                </p>
                            )}
                        </div>
                    </section>
