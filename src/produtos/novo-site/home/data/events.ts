...
export const EVENTOS: EventoMock[] = [
    ...
    { id: "bot-gre", titulo: "Botafogo x Grêmio", data: "2026-07-12", dataLabel: "12 jul", local: "Estádio Nilton Santos", cidade: "Rio de Janeiro", preco: 60, seed: "botgre", vibe: "unified", categoria: "esportes", tags: ["futebol", "brasileirão"], popularidade: 1500, status: "venda", futebol: { campeonato: "Brasileirão 2026", fase: "Rodada 14", torcidaUnica: true, casa: { abbr: "BOT", nome: "Botafogo", cor: "#111111", escudo: "https://upload.wikimedia.org/wikipedia/commons/c/cb/Escudo_Botafogo.png" }, fora: { abbr: "GRE", nome: "Grêmio", cor: "#1E6CB3", escudo: "https://upload.wikimedia.org/wikipedia/commons/0/08/Gremio_logo.svg" } } },
