...
export function ConfigurarNotificacoes() {
    ...
    return (
        <TicketSportsLayout>
            ...
            <div className="flex flex-1 flex-col px-5 py-4 pb-10">
                <p className="mb-4 text-md text-tertiary">Escolha o que você quer receber.</p>
                <div className="flex flex-col rounded-2xl border border-secondary">
                    {CONFIG_NOTIFICACOES.map((c, i) => (
                        <div
                            key={c.id}
