...
import { Announcement01, ArrowLeft, Check, MarkerPin01 } from "@untitledui/icons";
    ...
    return (
        <TicketSportsLayout>
            <div className="flex flex-1 flex-col px-6 pt-8 pb-10">
                ...
                <p className="mt-4 text-md leading-snug text-secondary">{grupo.descricao}</p>
                ...
                <div className="mt-8 flex flex-col gap-3">
                    <h2 className="text-md font-bold text-primary">Galeria de fotos</h2>
                ...
                <div className="mt-8 flex flex-col gap-3">
                    <h2 className="flex items-center gap-2 text-md font-bold text-primary">
                        <Announcement01 className="size-5 text-[#7C3AED]" /> Recados
                    </h2>
                    ...
                    {grupo.souCriador ? (
                        ...
                        <p className="text-sm text-tertiary">Apenas o criador do grupo pode enviar recados.</p>
                    )}

                    {recados.length === 0 ? (
                        <p className="text-sm text-tertiary">Nenhum recado ainda.</p>
                    ) : (
                        recados.map((r) => (
                            <div key={r.id} className="flex flex-col gap-1 rounded-xl border border-[#7C3AED]/20 bg-[#7C3AED]/5 p-3.5">
                ...
                {/* Participantes */}
                <div className="mt-8 flex flex-col gap-3">
                    <h2 className="text-md font-bold text-primary">Participantes ({grupo.participantes.length})</h2>
