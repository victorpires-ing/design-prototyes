import { ArrowLeft, Bell01, Settings01 } from "@untitledui/icons";
    ...
    return (
        <TicketSportsLayout>
            ...
            <div className="hub-rise flex flex-1 flex-col px-5 py-4 pb-10">
                <Bloco icon={Bell01} titulo="Notificações">
                        ...
                        {NOTIFICACOES.map((n) => (
                            <div
                                ...
                                className={cx(
                                    ...
                                    n.lida ? "border-secondary bg-primary" : "border-[#7C3AED]/20 bg-[#7C3AED]/5",
                                )}
                            >
