import { ArrowLeft, Clock, TrendUp02 } from "@untitledui/icons";
...
const Card = ({ titulo, children }: { titulo: string; children: React.ReactNode }) => (
    <section className="flex flex-col gap-4 rounded-2xl border border-secondary p-4">
    ...
    return (
        <TicketSportsLayout>
            ...
            <div className="hub-rise flex flex-1 flex-col gap-5 px-5 py-5 pb-10">
                ...
                <Card titulo="Assuntos mais comentados">
                ...
                <Card titulo="Esportes mais praticados">
                    <div className="flex flex-col gap-3">
                        {ESPORTES.map((e) => (
                ...
                {/* Horários de treino */}
                <Card titulo="Horários de treino">
                ...
                <Card titulo="Tempo médio de treino">
